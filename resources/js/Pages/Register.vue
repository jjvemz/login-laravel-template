                ...
                <div class="flex justify-center px-6 py-12">
                    ...
                    <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        <div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
                            <h3 class="py-4 text-2xl text-center text-gray-800 dark:text-gray-700">¡Registrese!</h3>
                            <form class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded" @submit.prevent="Register">
                                <div class="mb-4 md:flex md:justify-between">
                                    <div class="mb-4 md:mr-2 md:mb-0">
                                        <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-700" for="first_name">Nombre</label>
                                        <input
                                            class="w-full px-3 py-2 text-sm leading-tight text-gray-700 dark:text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                            id="first_name" v-model="first_name" type="text" placeholder="Nombre" />

                                    </div>
                                    <div class="md:ml-2">
                                        <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-700" for="last_name">Apellido</label>
                                        <input
                                            class="w-full px-3 py-2 text-sm leading-tight text-gray-700 dark:text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-700" for="email">Email</label>
                                    <input
                                        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 dark:text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="email" v-model="email" type="email" placeholder="Email" />

                                </div>
                                <div class="mb-4">
                                    <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-700" for="phone">Telefono</label>
                                    <input
                                        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 dark:text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                ...
                                <div class="mb-4 md:flex md:justify-between">
                                    <div class="mb-4 md:mr-2 md:mb-0">
                                        <label class="block mb-2 text-sm font-bold text-gray-700 dark:text-gray-700" for="password">Contraseña</label>
                                        <input
